        ...
        <div className="bg-zinc-950/50 backdrop-blur-2xl border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-zinc-900/50 border-white/10 text-white focus-visible:ring-primary h-12 rounded-xl transition-all"
                  required
                />
              </div>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-medium transition-all group relative overflow-hidden"
            >
